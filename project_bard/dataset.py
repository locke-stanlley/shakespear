...
Datasets and DataLoaders with 512-token context windows.
"""
import numpy as np
import torch
...
from config import (
    ...
    TRAIN_RATIO, VAL_RATIO, BATCH_SIZE, SEED, NUM_WORKERS
)
...
class ShakespeareDataset(Dataset):
    """
    Streams chunks of BLOCK_SIZE (512) from a memmap file.
